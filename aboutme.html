...
I received my Ph.D. in Geography from the University of Bonn, Germany in 2011, a Masters in City and Regional Planning from the Georgia Institute of Technology in 2001, and a Bachelor of Arts in Architectural History from the Savannah College of Art and Design in 1999.  Since 2006 my research and teaching has focused on the use of __statistical__ programming to advance data use for understanding human and community scale processes. My primary programming language of choice since 2010 has been R with the sp and sf (Pebesma & Bivand), raster (Hijmans), spatstat (Baddeley) and tidyverse (Wickham) packages, among many others.  While I started using python in 2007, more recently I have turned my attention to its __computational__ advantages, particularly as it relates to tensorflow, pytorch and a number of other machine / deep learning, probability and computer vision methods.

<br>
<br>  

Between 2001 and 2006, I authored numerous land use and development applications at the state, regional and county levels in both Georgia and Florida, and obtained certification as a member of the American Institute of Certified Planners (AICP).  I am also fluent in German, conversant in Portuguese, and informally conversant with Twi (Ghana), French and Spanish.  From 2007 until 2012, I held a permanent residence in Ghana, staying there for several extended periods while conducting field research and project related work.  While the scope of my teaching as a data scientist focuses on human development from a broader perspective, my primary research interest is on the __human development__ of West Africa with emphasis on the Repubic of Ghana.
